			...
			<li class="list-group-item" style="border-collapse:collapse">
				<form action="ListAccountsServlet" method="POST" style="border-collapse:collapse">
					<div class="row">
						...
						<div class="col-md-2"><a href="ListAccountsServlet?iban=<%= account.getIban() %>&sw=deleteaccount"><button class="btn btn-default"><span class="glyphicon glyphicon-minus"></span></a></button></div>
